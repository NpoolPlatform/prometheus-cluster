     ...
     stage('Config mysql user') {
      ...
      steps {
        sh (returnStdout: false, script: '''
            ...
            CREATE USER IF NOT EXISTS 'mysq_exporter'@'mysql.kube-system.svc.cluster.local' IDENTIFIED BY '$MYSQL_EXPORTER_PASSWORD';
            ALTER USER 'mysq_exporter'@'mysql.kube-system.svc.cluster.local' WITH  MAX_QUERIES_PER_HOUR 100 MAX_CONNECTIONS_PER_HOUR 10 MAX_USER_CONNECTIONS 10;
            GRANT SELECT ON *.* TO 'mysq_exporter'@'mysql.kube-system.svc.cluster.local';"
